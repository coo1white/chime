...
import { repoSlim } from "./repo-slim.ts";
...
export const TOOLS: Capability[] = [colimaDisk, projects, projectStatus, projectCheck, projectDoctor, projectHealth, memory, handoff, ledger, diskMaintenance, selfIteration, repoSlim];
